...
public class AppTest {
	...
	//Unit test for user login using wrong credentials
	@Test
	...
	//Unit test for admin login using wrong credentials
	@Test
	...
	//Unit test for successful admin login + create route
	@Test
	...
	//Unit test for Successful user login + Apply pass request
	@Test
	...
	//Unit test for successful user login + view all available routes
	@Test
